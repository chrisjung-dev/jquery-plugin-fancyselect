 ...
 * @license CC-BY-NC-SA
 *
 * Date: Wed Mar 24 23:40:58 2010 +0100 
 *
...
function(){a("div.options:visible").hide();a(document).unbind("keydown")};a.fn.FancySelect.findEntryByKey=function(c){var b="";b=c.which;try{console.log(c.which)}catch(d){}if(b>=48&&b<=122){var e=String.fromCharCode(b);c=a("div.options:visible li").filter(function(){return(new RegExp("^"+e,"i")).test(a(this).text())});c.parents("ul").find("li").trigger("mouseleave");c.first().trigger("mouseenter")}if(b==13){a("div.options:visible li.entry_hover").trigger("click");a("div.options:visible li.entry_selected").trigger("click")}};
a.fn.FancySelect.defaults={maxEntries:"8"}})(jQuery);
